...
- Install Pytorch. Can be downloaded here: https://pytorch.org/get-started/locally/. The original nnUNet-repo recommends installing the latest version with support for your hardware (cuda, mps, cpu). The code for the NLDL submission were using version 2.8.0 and Cuda 12.8
